...
<body>
        <div class="header">
            <h1>Tiệm Sách Sinh Viên - Chi Nhánh Việt Trì</h1>
        </div>
        <div class="banner">
            <div class="logo">
            ...
            <div class="banner-find">
                <li id="adress"><a href="#">Việt Trì<i class='bx bxs-chevron-down'></i></a></li>
            </div>
    ...
    ob_start();
		...
		if(isset($_POST['btnAdd'])){
            ...
            echo '<meta http-equiv="refresh" content="0; URL= danhsachtrasach.php"/>';
			header("Location: /svmuonsach1.php");
		}
	?>

<div class="container" style="margin-top: 30px;">
	<h2>Sinh Viên Trả Sách</h2>
			 	<form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form">
				 <div class="form-group">
						    <label for="txtTen" class="col-sm-2 control-label">Nhập Tên Bạn:</label>
							<div class="col-sm-10">
							      <input type="text" name="txtID" id="txtID" class="form-control" placeholder="Tên sách...." value='<?php echo isset($_POST["txtID"])?($_POST["txtID"]):"";?>'>
							</div>
					</div>	
					<div class="form-group">
				 ...
				 <div class="form-group">
                    ...
                    <div class="form-group">
						    <label for="txtMoTa" class="col-sm-2 control-label">Nhập Sách Cần Trả:</label>
							<div class="col-sm-10">
					...
					<div class="form-group">
						<div class="col-sm-offset-2">
						      <input type="submit"  class="btn btn-primary" name="btnAdd" id="btnAdd" value="Trả sách"/>
                              <input type="button" class="btn btn-primary" name="btnIgnore"  id="btnIgnore" value="Xem Danh Sách" onclick="window.location='danhsachtrasach.php'" />
