...
<link rel="stylesheet" type="text/css" href="style.css"/>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	<meta charset="utf-8" />
        ...
        <h1 style="text-align: center;">Danh Sách Sinh Viên Trả Sách</h1>
        <p style="margin: 30px">
        <img src="/img/add.jpg" alt="Add new" width="40px" height="40px" border="0" " /> <a style="font-size: 17px; text-decoration: none; color:chocolate; font-family: 'Nunito', sans-serif;" href="/svtrasachhv.php">Trả Thêm</a>
        <br>
        <br>
        <br>
        ...
        <table id="tablecategory" class="table table-striped table-bordered" cellspacing="0" width="100%">  
			...
			<tbody>
                <?php
                    ...
                    <a href="danhsachtrasach.php?function=del&&id=<?php echo $row["Cat_ID"]; ?>" onclick="return deleteConfirm()">
                    <?php
