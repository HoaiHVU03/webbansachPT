...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="product-headthumb">
            <a href="">Sách Toán</a>
            <a href="./sachgiaokhoa/sachtiengviet.php">Sách Tiếng Việt</a>
            <a href="/sachgiaokhoa/sachtienganh.php">Sách Tiếng Anh</a>
        </div>
        ...
        <ul class="products">
            ...
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 5</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">80.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 6</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">81.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 7</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">82.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 8</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">83.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 9</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">84.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 10</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">85.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 11</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">86.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Sách Toán 12</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">87.000 VND</div>
                    </div>
                </div>
            </li>
        </ul>
